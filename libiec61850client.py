...
if __name__=="__main__":
	...
	error = cl.select("iec61850://10.14.152.233:10102/IED1_XCBRGenericIO/CSWI2.Pos", "True")
	if error == 1:
		print("selected successfully")
	else:
		print("failed to select")	
	#control = None
	if cl.operate("iec61850://10.14.152.233:10102/IED1_XCBRGenericIO/CSWI2.Pos", "True") == 1:
		print("operated successfully")
	else:
		print("failed to operate")
	
	error = cl.select("iec61850://10.14.152.233:10102/IED1_XCBRGenericIO/CSWI1.Pos", "True")
	if error == 1:
		print("selected successfully")
	else:
		print("failed to select")	
	#control = None
	if cl.operate("iec61850://10.14.152.233:10102/IED1_XCBRGenericIO/CSWI1.Pos", "True") == 1:
		print("operated successfully")
	else:
		print("failed to operate")
